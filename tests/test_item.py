...
class TestItems(BaseTest):
    def test_get_items__empty(self):
        resp = self.open_without_auth('/items/', 'get', data='')
    ...
    def test_get__item(self):
        ...
        resp = self.open_without_auth('/items/{}'.format(item1.uuid), 'get', data='')
        assert resp.status_code == OK
    ...
    def test_get_item__empty(self):
        resp = self.open_without_auth('/items/{}'.format(uuid.uuid4()), 'get', data='')
    ...
    def test_delete_item__success(self):
        ...
        assert Item.count() == 0
        resp = self.open_without_auth('item/{}'.format(item1.uuid), 'get', data='')
        assert resp.status_code == NOT_FOUND
    ...
    def test_get_item_pictures__success(self):
        ...
        resp = self.open_without_auth('/items/{}/pictures'.format(item.uuid), 'get', data='')
    ...
    def test_get_item_pictures__failure_non_existing_item(self):
        resp = self.open_without_auth('/items/{}/pictures'.format(uuid.uuid4()), 'get', data='')
